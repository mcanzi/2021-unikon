...
* Small negative effect between 150-200 ms for mismatch condition (fronto-cenral) \pause (__MMN?__)
* Bigger positive effect between 500-700 ms for mismatch condition (centro-parietal) \pause (__P600?__)

## Discussion 

\begin{center}

No instance of \textbf{PMN} (in any of its forms) was found)
...
\small Special thanks to my supervisors __Dr Wendell Kimper__,  __Dr Patrycja Strycharczuk__ and to all the RAs: Hui Chen, Lauren Forrest, Chloe Gornall, Tristan Hill, Yuerong Shen, Ellen Symonds, Xinrong Wang, Ziyun Zhang 
