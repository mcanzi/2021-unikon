...
\begin{center}
\normalsize
Christma\textbf{/s-\textesh/} \textbf{/t-k/}apes  
...
The mismatch negativity reflects the perception of a deviant stimulus in a sequence of standard stimuli \pause
...
\begin{itemize}[<+->] 
\item Hundreds of studies 
\item Other paradigms include cloze-probability mismatch (e.g. Connolly and Phillips 1994)
\end{itemize}
...
\pause Three ERP experiments designed to investigate the elicitation of the PMN in contexts with no lexical activation.
...
\small \pause Slides for this talk are available on GitHub at the following repository: `mcanzi/2021_UNIKON`  
...
We fitted a LMEM to mean amplitude measured between 280 and 320 ms PSO. \pause Varying intercepts allowed for \texttt{Subject}
...
We fitted a linear mixed-effect regression model to mean amplitude measured between 280 and 320 ms PSO. \pause Varying intercepts allowed for \texttt{Subject}
